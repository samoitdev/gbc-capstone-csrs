...
@ComponentScan(basePackages="com.groupthink.csr")
@PropertySource({ "classpath:decider-persistence-mysql.properties", "classpath:security-persistence-mysql.properties" })
